<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sendmoney.aspx.cs" Inherits="personalinfo.sendmoney" %>
          ...
          &nbsp;&nbsp;&nbsp;
           ...
           &nbsp;&nbsp;&nbsp;
            ...
            <div class ="deppanel">
                ...
                <asp:TextBox ID="TextBox1" runat="server" placeholder ="Enter Recipient's ID" placeholder-align="center"></asp:TextBox>
                <br />
                <asp:Button ID="Button1" runat="server" Text="Enter" OnClick="Button1_Click"></asp:Button>
            </div>

            <asp:Panel ID="hiding" CssClass ="deppanel1" visible="false" runat="server">
                <div>
                    Send Money
                    <br />
            ...
            <asp:Label ID="Label9" runat="server"></asp:Label>
                ...
                <asp:TextBox ID="TextBox2" runat="server" min="100" max="10000" placeholder="Enter amount"></asp:TextBox>
                <br /><br />
                <asp:TextBox ID="TextBox3" runat="server" min="100" max="10000" type="password" placeholder="Confirm Password"></asp:TextBox>
                <br /><br />
                <asp:Button ID="Button2" runat="server" Text="Send Money" OnClick="Button2_Click"></asp:Button>
