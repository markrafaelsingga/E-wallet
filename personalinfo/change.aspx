<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="change.aspx.cs" Inherits="personalinfo.change" %>
          ...
          &nbsp;&nbsp;&nbsp;
           ...
           &nbsp;&nbsp;&nbsp;
            ...
            <div class="panel1">
                ...
                <br />
                <asp:TextBox ID="TextBox1" type="password" placeholder="Enter old password" runat="server"></asp:TextBox>
                <br /><br />
                <asp:TextBox ID="TextBox2" type="password" placeholder="Enter new password" runat="server"></asp:TextBox>
                <br /><br />
