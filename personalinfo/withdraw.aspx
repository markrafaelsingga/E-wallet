<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="withdraw.aspx.cs" Inherits="personalinfo.withdraw" %>
          ...
          &nbsp;&nbsp;&nbsp;
           ...
           &nbsp;&nbsp;&nbsp;
            ...
            <div class ="deppanel">
                ...
                <br />
                <asp:Button ID="Button1" runat="server" Text="Withdraw" OnClick="Button1_Click"></asp:Button>
            </div>
